...
Pull Requests can be opened here on GitHub and will be merged into the `main` branch. Deployment of changes to [e.coronawarn.app](https://e.coronawarn.app) (for event-registration) and [s.coronawarn.app](https://s.coronawarn.app) is done manually.
